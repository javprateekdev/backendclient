...
const Username = ({ tableManager, value, field, data, column, colIndex, rowIndex }) => {
    return (
        <div className='rgt-cell-inner' style={{display: 'flex', alignItems: 'center', overflow: 'hidden',background:"white"}}>
...
const MyAwesomeTable = () => <GridTable columns={columns} rows={rows} style={{background:"white"}} />;
